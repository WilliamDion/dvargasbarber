...
export default function Contact() {
  ...
  const address = "R. Fogaça da Cruz, 36 - Natal - Gravataí - RS"
  const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(address)}`

  return (
    <section id="ContactInfo" className="py-24 bg-zinc-950 text-white">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="space-y-8">
              ...
              >
                <div className="w-14 h-14 bg-zinc-900 border border-zinc-800 flex items-center justify-center group-hover:border-primary transition-colors">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-6">
                  <p className="text-xs uppercase tracking-widest text-zinc-500 font-bold">Horário de Atendimento</p>
