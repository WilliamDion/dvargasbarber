...
export default function Barbers({ onBook }: BarbersProps) {
  ...
  return (
    <section 
      id="barbeiros" 
      ref={sectionRef}
      className={`py-24 bg-black transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}
    >
          ...
          >
            {barbers.map((barber, index) => (
              <SwiperSlide key={barber.id}>
                <div className="group relative overflow-hidden bg-zinc-900 rounded-lg border border-zinc-800">
