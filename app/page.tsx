  ...
  return (
    <main className="min-h-screen bg-[#050505]">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-zinc-800/20 via-black to-black z-0"></div>
        ...
        <div className="relative z-10 text-center px-4 flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter mb-6">
            D'Vargas Barber<span className="text-primary inline-block hover:scale-110 transition-transform">Shop</span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <a href="#servicos" className="border border-zinc-700 text-white font-bold px-8 py-4 rounded-sm hover:bg-zinc-800 transition-all uppercase text-sm tracking-widest text-center">
              Ver Serviços
            </a>
          </div>
        </div>
